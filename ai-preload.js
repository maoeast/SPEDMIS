...
contextBridge.exposeInMainWorld('aiAPI', Object.freeze({
    ...
    updatePreference: (payload) => ipcRenderer.invoke(CHANNELS.preferenceUpdate, payload),
    ...
    setAgentToolsEnabled: (payload) => ipcRenderer.invoke(CHANNELS.agentSetToolsEnabled, payload),
    ...
    uploadAttachment: (payload) => ipcRenderer.invoke(CHANNELS.attachmentUpload, payload),
    listAttachments: (payload) => ipcRenderer.invoke(CHANNELS.attachmentList, payload),
    deleteAttachment: (payload) => ipcRenderer.invoke(CHANNELS.attachmentRemove, payload),
    readAttachmentDataUrl: (payload) => ipcRenderer.invoke(CHANNELS.attachmentReadDataUrl, payload),
    ...
    onChatToolStep: (callback) => subscribe(CHANNELS.chatToolStep, callback),
}));
