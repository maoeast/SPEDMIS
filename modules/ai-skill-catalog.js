...
//
// 正文由 tools/gen-skill-catalog.cjs 从 SIC-ADS 源项目读取生成，存为
// ai-skill-catalog.json（随包发布；package.json build.files 的 `!**/*.md`
// 禁止 .md 出货，故以 JSON 数据模块形式内联，与 modules/ai-agent-catalog.js
// 的「打包数据模块」思路一致）。
//
