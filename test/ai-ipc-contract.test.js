...
describe('AI IPC contract', () => {
    ...
    test('registers only the explicit AI request channels', () => {
        expect([...handlers.keys()]).toEqual([
            ...
            AI_CHANNELS.agentSetToolsEnabled,
            ...
            AI_CHANNELS.attachmentUpload,
            AI_CHANNELS.attachmentList,
            AI_CHANNELS.attachmentRemove,
            AI_CHANNELS.attachmentReadDataUrl,
        ]);
    });
